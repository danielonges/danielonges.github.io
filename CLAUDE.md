...
5. **Only the red playhead animates** — one sweep on load, settling to rest,
   honouring `prefers-reduced-motion`. Brackets, camera, bars, wordmark: static.
   The keyframes live in tokens.css; `Logo.astro` is the only consumer.
